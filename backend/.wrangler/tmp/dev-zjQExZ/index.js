...
// .wrangler/tmp/bundle-jnzYQS/checked-fetch.js
...
// .wrangler/tmp/bundle-jnzYQS/strip-cf-connecting-ip-header.js
...
async function generateId() {
  return bytesToBase64(crypto.getRandomValues(new Uint8Array(12))).replace(/[+/=]/g, "").slice(0, 16);
}
...
async function verifyJWT(token, secret) {
  ...
  const payload = JSON.parse(atob(unbase64url(body)));
  if (typeof payload["exp"] === "number" && payload["exp"] < Date.now() / 1e3) {
...
app.post("/api/auth/signup", async (c) => {
  ...
  const expiresAt = Math.floor(now / 1e3) + 7 * 24 * 60 * 60;
...
// ../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260628.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260628.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-jnzYQS/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260628.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-jnzYQS/middleware-loader.entry.ts
